...
export const typography = {
  ...
  bodyLarge: { fontFamily: 'Syne_400Regular', fontSize: 17, lineHeight: 26 },
  body: { fontFamily: 'Syne_400Regular', fontSize: 15, lineHeight: 24 },
  bodySmall: { fontFamily: 'Syne_400Regular', fontSize: 13, lineHeight: 20 },
  label: { fontFamily: 'Syne_500Medium', fontSize: 13, letterSpacing: 0 },
  labelSmall: { fontFamily: 'DMMono_400Regular', fontSize: 11, letterSpacing: 0.8 },
  caption: { fontFamily: 'DMMono_400Regular', fontSize: 9, letterSpacing: 2, textTransform: 'uppercase' as const },
  mono: { fontFamily: 'DMMono_400Regular', fontSize: 12 },
  monoSmall: { fontFamily: 'DMMono_400Regular', fontSize: 10, letterSpacing: 1.5 },
  monoCaption: { fontFamily: 'DMMono_400Regular', fontSize: 9, letterSpacing: 2, textTransform: 'uppercase' as const },
  button: { fontFamily: 'Syne_600SemiBold', fontSize: 15, letterSpacing: 0.3, lineHeight: 20 },
  buttonSmall: { fontFamily: 'Syne_600SemiBold', fontSize: 13, letterSpacing: 0.3, lineHeight: 18 },
};

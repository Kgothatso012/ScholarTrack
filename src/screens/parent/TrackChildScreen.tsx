...
const styles = StyleSheet.create({
  ...
  mapText: { fontSize: 18, fontWeight: 'bold', color: '#888888', marginTop: 10 },
  ...
  trackingTitle: { fontSize: 16, fontWeight: 'bold', color: '#FFB81C' },
  ...
  trackingInfoText: { marginLeft: 10, fontSize: 14, color: '#ffffff' },
  ...
  stopInfo: { flex: 1 },
  stopName: { fontSize: 14, color: '#ffffff' },
  currentStopText: { fontWeight: 'bold', color: '#FFB81C' },
  stopTime: { fontSize: 12, color: '#888888', marginTop: 2 },
});

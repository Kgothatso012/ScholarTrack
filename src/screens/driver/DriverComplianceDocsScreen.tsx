...
const styles = StyleSheet.create({
  ...
  scoreTitle: { fontSize: 16, fontWeight: 'bold', color: '#333' },
  scoreSubtitle: { fontSize: 13, color: '#666', marginTop: 3 },
  ...
  legalText: { flex: 1, marginLeft: 8, fontSize: 12, color: '#333', lineHeight: 18 },
  ...
  docName: { fontSize: 14, fontWeight: 'bold', color: '#333', flex: 1 },
  statusBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
  statusText: { color: '#fff', fontSize: 10, fontWeight: 'bold' },
  docDesc: { fontSize: 12, color: '#666', marginTop: 3 },

...
export default function SettingsScreen({ navigation }: Props) {
  ...
  const styles = (colors: ThemeColors) => StyleSheet.create({
    ...
    dangerBtn: { backgroundColor: colors.danger, padding: spacing.md, borderRadius: borderRadius.md, alignItems: 'center', marginTop: spacing.lg, borderTopWidth: 2, borderTopColor: 'rgba(255,255,255,0.2)', shadowColor: colors.danger, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 12, elevation: 4 },
